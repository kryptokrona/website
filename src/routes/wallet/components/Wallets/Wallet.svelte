...
<li
	class="col-span-1 divide-y divide-neutral-600 rounded-lg bg-neutral-800 border border-neutral-700 shadow"
>
	<div class="flex w-full items-center justify-between space-x-6 p-6">
		<div class="flex-1 truncate">
			<div class="flex items-center space-x-3">
				<h3 class="truncate text-lg font-medium text-neutral-50">{title}</h3>
				<span
			...
			<p class="mt-1 truncate text-sm text-neutral-400">{text}</p>
		</div>
	</div>
	<div>
		<div class="-mt-px flex divide-x divide-neutral-600">
